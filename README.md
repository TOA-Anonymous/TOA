...
| **TOA (Ours)**      |                             | [bash](bash/exp_alpaca_eval/run_generate.api.mcts.pre_load.sh)                |
...
<table style="border: none; width: 100%;">
  ...
  <tr>
    <td align="center" colspan="2">
      <img src="./figures/table_data_syn_alpaca_eval.png" alt="Image 1" style="height: 350px; object-fit: contain;"/>
      <br>
...
Outputs are generated using [**Ultrafeedback prompts**](https://huggingface.co/datasets/princeton-nlp/llama3-ultrafeedback-armorm), sampling 160 responses per prompt. The best response is retained using [**ArmoRM-Llama3-8B-v0.1**](https://huggingface.co/RLHFlow/ArmoRM-Llama3-8B-v0.1).
