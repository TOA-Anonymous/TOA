...
# model params
model_num=1
root_configs=../launch_large_models_sglang/server_configs_single/
root_reward_configs=../launch_large_models_sglang/server_reward/
config_name=single_model.reward=reward_model
...
for n_samples in 160 ; do
    ...
    output=../../output/$task/${data_name}.source=${source}.mode=${mode}.model_num=${model_num}.config=${short_config_name}.n_samples=${n_samples}.temp=${temperature}.top_p=${top_p}.temp_v=1.jsonl
